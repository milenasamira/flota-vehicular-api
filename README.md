...
Pruebas Unitarias
Se utilizó Pytest para la verificación. Las pruebas unitarias se enfocaron en la capa de Servicios/Repositorios, usando mocks para simular la base de datos. Esto confirma que la lógica crítica (ej. actualizar_estado) es correcta 
